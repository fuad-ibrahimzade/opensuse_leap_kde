...
3. Go to install directory product JetBrains ( Example : C:\Program Files\JetBrains\JetBrains Rider 2021.2.2\bin ) find *.exe.vmoptions ( Example : rider64.exe.vmoptions ) open with Notepad++ add end line & Save:
